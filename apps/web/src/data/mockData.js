...
export const STATES_AND_DISTRICTS = {
  'Uttar Pradesh': ['Ghaziabad', 'Gorakhpur', 'Varanasi', 'Lucknow', 'Kanpur', 'Meerut', 'Agra', 'Prayagraj'],
  'Punjab': ['Ludhiana', 'Amritsar', 'Jalandhar', 'Patiala', 'Bhatinda', 'Khanna'],
  'Haryana': ['Karnal', 'Ambala', 'Hisar', 'Rohtak', 'Kurukshetra'],
  'Tamil Nadu': ['Thanjavur', 'Chennai', 'Madurai', 'Coimbatore', 'Trichy', 'Salem', 'Cuddalore'],
  'Andhra Pradesh': ['Guntur', 'Krishna', 'Visakhapatnam', 'Vijayawada', 'Kurnool'],
  'Telangana': ['Hyderabad', 'Warangal', 'Nizamabad', 'Karimnagar'],
  'Karnataka': ['Bengaluru', 'Mysuru', 'Hubballi', 'Belagavi', 'Mangaluru'],
  'Kerala': ['Wayanad', 'Palakkad', 'Idukki', 'Thrissur', 'Kottayam'],
  'Maharashtra': ['Pune', 'Nashik', 'Nagpur', 'Latur', 'Chhatrapati Sambhajinagar'],
  'Gujarat': ['Ahmedabad', 'Surat', 'Rajkot', 'Vadodara', 'Bhavnagar'],
  'Madhya Pradesh': ['Bhopal', 'Indore', 'Gwalior', 'Jabalpur', 'Ujjain'],
  'Rajasthan': ['Jaipur', 'Jodhpur', 'Bikaner', 'Udaipur', 'Kota', 'Jaisalmer'],
  'Bihar': ['Patna', 'Gaya', 'Muzaffarpur', 'Bhagalpur', 'Darbhanga'],
  'West Bengal': ['Kolkata', 'Burdwan', 'Howrah', 'Siliguri', 'Murshidabad'],
  'Odisha': ['Bhubaneswar', 'Cuttack', 'Puri', 'Balasore', 'Sambalpur'],
  'Jharkhand': ['Ranchi', 'Jamshedpur', 'Dhanbad', 'Bokaro'],
  'Chhattisgarh': ['Raipur', 'Bhilai', 'Bilaspur', 'Korba'],
  'Assam': ['Guwahati', 'Dibrugarh', 'Silchar', 'Jorhat'],
  'Himachal Pradesh': ['Shimla', 'Dharamshala', 'Mandi', 'Kullu'],
