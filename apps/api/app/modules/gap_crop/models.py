"""SQLAlchemy models for Gap Crop Engine module.
...
class CropCatalog(Base, UUIDPrimaryKey, Timestamped):
    """Database table: crop_catalog"""
...
class RegionalCropCalendar(Base, UUIDPrimaryKey, Timestamped):
    ...
    district_name: Mapped[str] = mapped_column(String(120), nullable=False, index=True)
